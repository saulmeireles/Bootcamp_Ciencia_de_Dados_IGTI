...
# Obtem o quantil (t crítico) para uma distribuição t com gl graus de liberdade. A um
# alfa de 5%
...
abline(v = -quantil,col = 'blue',lwd = 2)
abline(v = t, col = 'red')# Observe como o tcalculado é muito menor que o tcrítico. Está
...
# Podemos também obter o t crítico para uma distribuição t com 19 (n-1=20-1) graus
# de liberdade ao nível de confiança de 90%

tcrítico_teste_t_pareado <- -qt(p = 0.9, df = 19)
tcrítico_teste_t_pareado

# Devido ao teste ser unilateral a
# esquerda a distribuição t ser simétrica, nossa estatística de teste será negativa

# Observe que o t calculado é maior que o t critico. Como estamos em um teste
# unilateral a esquerda o t calculado
...
# É bastante comum também analisarmos a https://d36cb4a794f043b299e8856cf9dd86d0.app.rstudio.cloud/graphics/plot_zoom_png?width=561&height=331variabilidade nas distintas populações com uso de boxplot
