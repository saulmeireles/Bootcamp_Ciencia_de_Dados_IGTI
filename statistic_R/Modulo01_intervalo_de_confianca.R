...
########## Intervalo de confiança para média amostral ####
########## pela distribuição Normal Padrão ###############


# Obter o intervalo de confiança para uma variável cuja média = 30, desvio padrão = 7,31
# e n = 30
...
# Vamos gerar com o comando rnorm() uma variável aleatoria com média 30, desvio
# padrão 7,31 e n = 30
...
# Observe que mesmo a variável original não seguindo uma distribuição normal, o
...
# Caso o intervalo desejado seja de 95% de confiança, temos que ordenar essa
# distribuição
...
# Iremos calcular o intervalo de confiança usando o Bootstrap e também com a
# distribuição
